...
# Form implementation generated from reading ui file 'e:\github\tools-box\tools-box\pythonGUI\Tran.ui'
#
...
class Ui_Tran(object):
    ...
    def retranslateUi(self, Tran):
        ...
        self.label.setText(_translate("Tran", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">CSV-xlsx格式转换工具</span></p></body></html>"))
        self.pushButton.setText(_translate("Tran", "文件转换"))
        self.pushButton_2.setText(_translate("Tran", "文件读取"))
        self.pushButton_3.setText(_translate("Tran", "退出程序"))
